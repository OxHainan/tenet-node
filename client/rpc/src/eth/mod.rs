...
// Frontier
use tc_rpc_core::{types::*, EthApiServer};
	...
	EC: EthConfig<B, C>,
{
	...
	async fn storage_at(
		...
		_address: H160,
		_index: U256,
		_number_or_hash: Option<BlockNumberOrHash>,
	) -> RpcResult<H256> {
		Err(Error::Custom(
			"eth_getStorageAt method is already forbidden".to_string(),
		))
	}
...
pub struct BlockInfo<H> {
	block: Option<EthereumBlock>,
	receipts: Option<Vec<tp_ethereum::Receipt>>,
